...
<head>
    ...
    <title>E- Absensi Halaman Registrasi</title>
...
<body class="bg-gradient-info">
    ...
    <div class="container">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        <a href="index.php" class="btn btn-success btn-circle btn-md shadow mb-4   ">
                                    ...
                                    <form action="" class="user" method="post">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" placeholder="Enter Username..." id="username" name="username">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-success btn-user btn-block" name="register">
                                            Register
                                        </button>
        ...
        <center>
            ...
            <!-- <a href="index.php" class="btn btn-danger btn-circle btn-lg">
            <i class="fas fa-home"></i>
        </a>
        <a href="index.php" class="btn btn-danger btn-circle btn-lg">
            <i class="fas fa-home"></i>
