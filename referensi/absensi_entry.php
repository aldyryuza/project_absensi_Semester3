...
<div class="pull-right">
  <button class=" btn btn-flat btn-default" id="btnbatal" title="Membatalkan seleksi 'semua hadir' atau 'kosongkan' &#10; dan menampilkan presensi hari ini yang sudah tersimpan.">Batalkan</button>
...
//----------- masuk semua -----------------  
  function hadir_massal(){
    ...
    if(jml<=0)alert("Tidak ada yang berhasil diubah.\nSemua siswa telah diabsen sebelumnya.");
    if(jml>=1)alert("Berhasil diubah menjadi 'hadir': "+jml);
  }
...
//-------------------- menyimpan data massal----------- 
  ...
  function koleksi_data(){
    ...
    if(valgroup.length<1){alert("Keterangan Presensi belum dipilih.");return false;}
